...
class User implements UserInterface
{
     ...
     * @Groups({"tickets_read", "users_read"})
     */
    private $id;
     ...
     * @Assert\Length(min=3, minMessage="Ce champ doit faire entre 3 et 255 caractères",
     *                max=255, maxMessage="Ce champ doit faire entre 3 et 255 caractères")
     */
    private $firstName;
