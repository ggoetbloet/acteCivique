...
class TicketUserSubscriber implements EventSubscriberInterface
{
    ...
    {
        return [
            KernelEvents::VIEW => ['setUserForTicket', EventPriorities::PRE_VALIDATE]
        ];
    }

    public function setUserForTicket(ViewEvent $event)
    {
